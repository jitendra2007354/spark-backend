...
app.use('/api/sponsor', sponsor_routes_1.default);
...
const startServer = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, notification_cron_service_1.scheduleSponsorNotificationCleanup)(); // Add the new job
        server.listen(port, () => {
