...
interface DriverCreationAttributes extends Optional<DriverAttributes, 'id' | 'isApproved' | 'rating'> {}
...
Driver.init({
  ...
  driverLicenseNumber: {
    ...
    allowNull: false,
    unique: true, // Each license should be unique
  },
  ...
  isApproved: {
    ...
    defaultValue: false, // Drivers must be approved
  },
  rating: {
