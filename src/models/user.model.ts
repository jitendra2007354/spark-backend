...
interface UserCreationAttributes extends Optional<UserAttributes, 'id' | 'isOnline' | 'isBlocked' | 'walletBalance' | 'lowBalanceSince' | 'averageRating' | 'outstandingPlatformFee'> {}
