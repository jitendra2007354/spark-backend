...
const sendAdminNotification = (target, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // 1. Save notifications to the database for persistence (History)
        ...
        yield notification_model_1.default.bulkCreate(notificationsData);
        // Send the notification to each targeted user via WebSocket
        users.forEach(user => {
            (0, socket_service_1.sendMessageToUser)(user.id, 'admin_notification', payload);
        });
