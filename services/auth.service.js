...
exports.loginAdmin = exports.loginGuest = exports.loginOrRegister = exports.verifyOtpService = exports.sendOtpService = void 0;
...
const verifyOtpService = (phoneNumber, otp) => __awaiter(void 0, void 0, void 0, function* () {
    const storedOtp = otpStore.get(phoneNumber);
    // Allow '123456' as a universal bypass for testing
...
const loginOrRegister = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (isDriver && created) {
            ...
            // Also create a default Vehicle entry for the driver
            yield vehicle_model_1.default.create({
                userId: user.id,
                vehicleNumber: vehicleNumber,
                vehicleModel: vehicleModel,
                vehicleType: vehicleType,
        ...
        if (!created && user.userType !== userType) {
            // Allow Driver to login even if the current request lacks driver details (inferred as Customer)
