...
const openTicket = (userId, subject, description) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Notify admins about the new ticket in real-time
    (0, socket_service_1.sendMessageToAdminRoom)('new_support_ticket', ticket);
    return ticket;
});
...
const closeTicket = (ticketId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ticket.save();
    // Notify the user that their ticket has been closed/resolved
    (0, socket_service_1.sendMessageToUser)(ticket.userId, 'support_ticket_closed', ticket);
    return ticket;
});
