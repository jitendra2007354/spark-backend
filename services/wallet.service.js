...
const updateUserWallet = (driverId, amount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield database_service_1.default.transaction((t) => __awaiter(void 0, void 0, void 0, function* () {
        // 1. Find the Driver profile first to get the userId
        const driverProfile = yield driver_model_1.default.findByPk(driverId, { transaction: t });
        if (!driverProfile)
            throw new Error('Driver profile not found.');
        // 2. Find the User associated with this driver
        const driver = yield user_model_1.default.findByPk(driverProfile.userId, { transaction: t, lock: true });
        if (!driver)
            throw new Error('Driver user account not found.');
