...
router.post('/send', auth_middleware_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const chatMessage = yield (0, chat_service_1.saveChatMessage)({ rideId, senderId, receiverId, message });
...
router.get('/messages/:rideId', auth_middleware_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const messages = yield (0, chat_service_1.getChatHistory)(Number(rideId));
        res.json(messages);
    }
    catch (error) {
