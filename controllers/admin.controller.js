...
const sendNotification = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Use the centralized service to handle both DB persistence and WebSocket delivery
        yield (0, notification_service_1.sendAdminNotification)('all', { title, message });
        res.status(200).json({ message: `Notification sent successfully to all users.` });
    }
    catch (error) {
...
const createRealtimeNotificationHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // This now saves to DB and sends via WebSocket
        yield (0, notification_service_1.sendAdminNotification)(target, { title, message });
        res.status(200).json({ success: true, message: 'Notification dispatched and saved.' });
    }
    catch (error) {
