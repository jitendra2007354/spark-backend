...
exports.pollRideRequests = exports.unblockDriver = exports.blockDriver = exports.getNearbyDrivers = exports.getDriverRides = void 0;
...
const pollRideRequests = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
        // In a real app, filter by location. For now, return the latest pending ride.
        const ride = yield ride_model_1.default.findOne({
            where: { status: ride_model_1.RideStatus.PENDING },
            include: [{
                    model: user_model_1.default,
                    as: 'customer',
                    attributes: ['id', 'firstName', 'lastName', 'pfp', 'averageRating']
                }],
            order: [['createdAt', 'DESC']]
        });
        if (!ride) {
            return res.status(200).json(null); // No rides available
        }
        const r = ride;
        ...
        const response = {
            id: ride.id,
            customer: {
                id: (_a = r.customer) === null || _a === void 0 ? void 0 : _a.id,
                name: `${(_b = r.customer) === null || _b === void 0 ? void 0 : _b.firstName} ${(_c = r.customer) === null || _c === void 0 ? void 0 : _c.lastName}`,
                rating: ((_d = r.customer) === null || _d === void 0 ? void 0 : _d.averageRating) || 5.0,
                pfp: (_e = r.customer) === null || _e === void 0 ? void 0 : _e.pfp
            },
            pickupLocation: Object.assign(Object.assign({}, pickup), { latitude: pickup.latitude || pickup.lat, longitude: pickup.longitude || pickup.lng }),
            dropoffLocation: Object.assign(Object.assign({}, dropoff), { latitude: dropoff.latitude || dropoff.lat, longitude: dropoff.longitude || dropoff.lng }),
            fare: ride.fare,
            distance: r.distance,
            duration: r.duration,
            vehicleType: ride.vehicleType,
            expiresAt: ride.offerExpiresAt ? new Date(ride.offerExpiresAt).getTime() : Date.now() + 30000
        };
        res.status(200).json(response);
    }
    catch (error) {
        res.status(500).json({ error: 'Failed to poll requests', message: error.message });
    }
});
exports.pollRideRequests = pollRideRequests;
